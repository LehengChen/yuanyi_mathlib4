...
`Action.forget V G` preserves the limit of `K` and `F` preserves the limit of
`K ⋙ forget V G`. -/
instance mapActionPreservesLimit_of_preserves (K : J ⥤ Action V G)
...
`Action.forget V G` preserves limits of shape `J` and `F` preserves limits of shape `J`. -/
instance mapActionPreservesLimitsOfShapeOfPreserves [PreservesLimitsOfShape J F]
    [PreservesLimitsOfShape J (Action.forget V G)] :
    PreservesLimitsOfShape J (F.mapAction G) where

/-- `F.mapAction : Action V G ⥤ Action W G` preserves limits of some size if
`Action.forget V G` preserves limits of that size and `F` preserves limits of that size. -/
instance preservesLimitsOfSize_of_preserves [PreservesLimitsOfSize.{w₂, w₁} F]
    [PreservesLimitsOfSize.{w₂, w₁} (Action.forget V G)] :
    PreservesLimitsOfSize.{w₂, w₁} (F.mapAction G) where

/-- `F.mapAction : Action V G ⥤ Action W G` preserves finite limits if
`Action.forget V G` preserves finite limits and `F` preserves finite limits. -/
instance [PreservesFiniteLimits F] [PreservesFiniteLimits (Action.forget V G)] :
...
`Action.forget V G` preserves the colimit of `K` and `F` preserves the colimit of
`K ⋙ forget V G`. -/
instance mapActionPreservesColimit_of_preserves (K : J ⥤ Action V G)
...
`Action.forget V G` preserves colimits of shape `J` and `F` preserves colimits of shape `J`. -/
instance mapActionPreservesColimitsOfShapeOfPreserves [PreservesColimitsOfShape J F]
    [PreservesColimitsOfShape J (Action.forget V G)] :
    PreservesColimitsOfShape J (F.mapAction G) where

/-- `F.mapAction : Action V G ⥤ Action W G` preserves colimits of some size if
`Action.forget V G` preserves colimits of that size and `F` preserves colimits of that size. -/
instance preservesColimitsOfSize_of_preserves [PreservesColimitsOfSize.{w₂, w₁} F]
    [PreservesColimitsOfSize.{w₂, w₁} (Action.forget V G)] :
    PreservesColimitsOfSize.{w₂, w₁} (F.mapAction G) where

/-- `F.mapAction : Action V G ⥤ Action W G` preserves finite colimits if
`Action.forget V G` preserves finite colimits and `F` preserves finite colimits. -/
instance [PreservesFiniteColimits F] [PreservesFiniteColimits (Action.forget V G)] :
